...
import { Card, fetchNews, news_cards } from './news';
...
<template>
    <div class="landing-page">
        <div class="welcome">
            <div class="title">Non-Ordinary World</div>
            <div class="sub-title">Твои возможности ограничиваются только твоим воображением</div>
        </div>
